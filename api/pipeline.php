...
function assertCanMutateLead(PDO $db, array $user, int $leadId): string
{
    ...
    // Every other role (sales_agent / carfax / filter / tlo) must own
    // the lead. Sales agents add notes / tasks / labels / contact
    // logs on their own assigned leads; they're not pooled operators.
...
const LEAD_STATUSES = [
    ...
    'wrong_number','no_answer','deal_closed',
